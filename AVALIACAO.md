...
> **Níveis abaixo são uma proposta gerada em sessão de IA (10/07)**, sem escala oficial da rubrica no material do curso — usei 1–5 (1 Insuficiente · 2 Básico · 3 Adequado · 4 Bom · 5 Excelente) por ser a convenção mais comum. O grupo ajusta antes do fechamento em 12/07.

## Evidências por critério

1. **Decomposição de domínio** — nível proposto: **5/5 (Excelente)**
...
2. **Comunicação assíncrona** — nível proposto: **5/5 (Excelente)**
...
3. **Idempotência e consistência** — nível proposto: **5/5 (Excelente)**
   Evidência:
...
4. **Cache** — nível proposto: **4/5 (Bom)**
   Evidência:
   ...
   - Gap conhecido (não 5/5): cache Caffeine é local à instância — decisão consciente e justificada na ADR-006, mas é uma limitação real caso `extrato-consulta` escale horizontalmente (instâncias não compartilham cache/invalidação entre si).

5. **Resiliência** — nível proposto: **4/5 (Bom)**
   Evidência:
   ...
   - Gap conhecido (não 5/5): o encaminhamento físico à DLQ (Kafka/Rabbit reais) ainda não foi demonstrado no plano A — pendente para o docker-compose/demo de 12/07.

6. **Testabilidade** — nível proposto: **5/5 (Excelente)**
   Evidência:
